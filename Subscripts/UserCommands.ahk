...
{
    gui_destroy()
	run %A_ScriptDir%\Subscripts\SaveClip.pyw
}
...
else if shortcut = ? ; Command list
{
    ...
    Run %A_ScriptDir%\Subscripts\ShowList.pyw
}
else if shortcut = add ; Add shortcut
{
	gui_destroy()	
	Run %A_ScriptDir%\Subscripts\AddShortcut.pyw
}
else if shortcut = rem ; Remove shortcut
{
	gui_destroy()	
	Run %A_ScriptDir%\Subscripts\RemoveShortcut.pyw
}
